...
// Función para dibujar la figura en formato vectorizado
function drawVectorizedFigure() {
...
document.getElementById("dibujarBtn").addEventListener("click", drawVectorizedFigure);
